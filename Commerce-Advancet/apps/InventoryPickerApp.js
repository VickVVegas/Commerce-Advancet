...
export class InventoryPickerApp extends Application {
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      title: game.i18n.localize("KULT.NPCAuto.SellTitle"),
  ...
  async _sell(ev) {
    try {
      ...
      const sellRate = game.settings.get("commerce-automate", "sellRate");
      ...
      const npcPath = game.settings.get("commerce-automate", "npcCurrencyPath");

      const npcMoney = foundry.utils.getProperty(this.actorNPC, npcPath) ?? 0;
      if (npcMoney < value)
        return ui.notifications.warn(
          game.i18n.localize("KULT.NPCAuto.WarnNPCMoney")
        );
      ...
      ui.notifications.info(
        game.i18n.format("KULT.NPCAuto.SellOK", {
          qty,
          name: item.name,
          price: value,
        })
      ...
      ui.notifications.error(
        e.message || game.i18n.localize("KULT.NPCAuto.ErrSell")
      );
    }
  }
}
